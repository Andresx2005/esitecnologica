...
function Fsiguiente(){
    ...
    if(pregunta.classList.item(1) == "2"){
        pregunta.innerHTML = "¿Qué es el género?"
        opcion1.innerHTML = "Algo que va cambiando."
        opcion2.innerHTML = "Se va formando."
        opcion3.innerHTML = "Todas son correctas."
    }
    if(pregunta.classList.item(1) == "3"){
        pregunta.innerHTML = "La igualdad de genero es:"
        opcion1.innerHTML = "Un derecho humano fundamental."
        opcion2.innerHTML = "Una invención de unas personas."
        opcion3.innerHTML = "La igualdad del sexo de las personas."
    }
}
